...
import { Globe, Plus, ArrowUpDown, LayoutGrid, Share2 } from 'lucide-react';
...
export default function WorldSystemsPage() {
  ...
  <Button variant="primary" onClick={() => setCreateOpen(true)}><Plus size={16} />New World System</Button></div></header>
