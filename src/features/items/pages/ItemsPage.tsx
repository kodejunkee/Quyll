...
import { Sword, Plus, ArrowUpDown, LayoutGrid, Share2 } from 'lucide-react';
...
export default function ItemsPage() {
  ...
  <Button variant="primary" onClick={() => setCreateOpen(true)}><Plus size={16} />New Item</Button></div></header>
